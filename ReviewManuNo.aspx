<%@ Page Title="" Language="C#" MasterPageFile="~/stuplaza_BgIndex.Master" AutoEventWireup="true" CodeBehind="ReviewManuNo.aspx.cs" Inherits="whut.stuplaza.UI.ReviewManuNo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH4" runat="server">
    <span><a href="default.aspx" >首页</a></span><span><</span><span><a href="#">审核未通过稿件</a></span>
</asp:Content>
