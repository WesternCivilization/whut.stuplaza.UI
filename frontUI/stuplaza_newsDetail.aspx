<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stuplaza_newsDetail.aspx.cs" Inherits="whut.stuplaza.UI.frontUI.stuplaza_newsDetail" %>
...
<style type="text/css">
    .text{height:auto;}
	.text p span.caption{font-size:18px; font-weight:bold;}
</style>
 ...
 <div id="main">
	<div id="container">	
		...
		<div id="location">
			...
			<span>></span>
			<a href="stuplaza_articleList.aspx?category=2">新闻动态</a>	
            <span>></span>
			<span>正文</span>		
		</div>
		<!--办事指南-->
		<div id="content">
            ...
            <div class="info">
			   发布时间：<span><%=model.ArticleTime%></span>
			   发布部门：<span><%=model.ArticleSector %></span>
               发布人：<span><%=model.ArticlePostStaff %></span>
			</div>
			<div class="text">
      ...
      <%-- <div class="share">
		   <span>分享到：</span>
		   <div><a class="icon icon1" href="javascript:void(0)" onclick="shareToQzone()"></a></div>
		   <div><a class="icon icon2" href="javascript:void(0)" onclick="shareToSinaWB()"></a></div>
		   <div><a class="icon icon4" href="javascript:void(0)" onclick="shareToQQ()"></a></div>
		</div>--%>
