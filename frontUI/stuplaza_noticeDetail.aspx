<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stuplaza_noticeDetail.aspx.cs" Inherits="whut.stuplaza.UI.frontUI.stuplaza_noticeDetail" %>
 ...
 <div id="main">
	<div id="container">	
		...
		<div id="location">
			...
			<span>></span>
			<a href="stuplaza_articleList.aspx?category=1">通知公告</a>	
			<span>></span>
			<span>正文</span>		
		</div>
		<!--办事指南-->
