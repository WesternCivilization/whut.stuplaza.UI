<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stuplaza_manuDetail.aspx.cs" Inherits="whut.stuplaza.UI.frontUI.stuplaza_manuDetail" %>
 ...
 <div id="main">
	<div id="container">	
		...
		<div id="location">
			...
			<span>></span>
			<a href="stuplaza_manuList.aspx">学院新闻</a>	
            <span>></span>
			<span>正文</span>		
		</div>
		<!--办事指南-->
		<div id="content">
		    <div class="title">
			    <%=model.ManuScriptTitle %><hr />
			</div>
            <div class="info">
			    发稿人：<span><%=model.ManuScriptAuthor %></span>
				时间：<span><%=model.ManuScriptTime %></span>
                所属学院：<span><%=model.ManuScriptAcademy %></span>
                责编：<span><%=model.ManuScriptReviewer %></span>
			</div>
			<div class="text">
