<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stuplaza_filecomDetail.aspx.cs" Inherits="whut.stuplaza.UI.frontUI.stuplaza_filecomDetail" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>学工广场 常用下载</title>
...
<%--    <div id="web_bg">
	...
	<div id="main">
		...
		<div id="location">
			...
			<span>></span>
			<a href="stuplaza_fileList.aspx">制度文件</a>	
			<span>></span>
			<span>正文</span>		
		</div>
		<!--办事指南-->
		<div id="content">
		    <div class="title">
			    <%=model.FileSummary %><hr />
			</div>
            <div class="info">
			    发布部门：<span>--<%=model.FileSector %></span>
				时间：<span><%=model.FileTime %></span>
                下载次数：<span><%=model.FileDowNum %></span>
			</div>
			<div class="text">
