<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stuplaza_fileDetail.aspx.cs" Inherits="whut.stuplaza.UI.frontUI.stuplaza_fileDetail" %>
 ...
 <div id="main">
	<div id="container">		
		...
		<div id="location">
			...
			<span>></span>
			<a href="stuplaza_fileList.aspx">常用下载</a>	
			<span>></span>
			<span>正文</span>		
		</div>
		<!--办事指南-->
